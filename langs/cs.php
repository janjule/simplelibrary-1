...
$translations = [
    ...
    "PUBLICATION_CHOOSE_AUTHOR" => "Vyber autora",

    "AUTHOR_ADD_HTMLTITLE"      => "Přidat autora publikace",
    "AUTHOR_ADD_FIRSTNAME"      => "První jména autora",
    "AUTHOR_ADD_LASTNAME"       => "Příjmení autora",
